...
export class ItemDropdown extends SimpleSlice {
    ...
    getFormattingItems(localizationManager, items) {
        return items.map((item) => {
            return Object.assign(Object.assign({}, item), { displayName: (localizationManager && item.displayNameKey) ? localizationManager.getDisplayName(item.displayNameKey) : item.displayName });
        });
    }
