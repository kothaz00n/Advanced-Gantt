...
import { ILabelLayout, IDataLabelInfo, DataPointLabels } from "./dataLabelInterfaces";
/**
...
export default class DataLabelArrangeGrid {
    ...
    private createBaseTextProperties;
    private initializeCellSize;
    private calculateMaxLabelSizes;
    private getFontSize;
    private measureTextSize;
    private updateMaxCellSize;
    private adjustEmptyCellSizes;
